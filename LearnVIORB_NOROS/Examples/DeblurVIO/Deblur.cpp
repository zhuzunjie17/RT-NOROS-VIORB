...
// 		"/home/zhuzunjie/Documents/data/RealsenseData/lab/COLOR.txt" 
// 		"/home/zhuzunjie/Documents/data/RealsenseData/lab/color"
		// ros::shutdown();
		return 1;
	}
	...
	for(;j<iListData.size();j++)
	{
		...
		cout<< "this frame imu size:" << vimuData.size()<<endl;
